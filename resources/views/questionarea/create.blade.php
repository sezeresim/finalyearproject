            ...
            <form method="post" action="/questionarea/store">
              ...
              <div class="form-group">
                ...
                <input name="title" type="text" class="form-control" id="title" aria-describedby="TitleHelp"
                       autocomplete="off" placeholder="Testinize İsim Veriniz.">
                @error('title')
              ...
              <div class="form-group">
                ...
                <textarea name="purpose" type="text" rows="3" class="form-control" id="purpose"
                          aria-describedby="purposeHelp" placeholder="Testinizin Amacı Nedir."></textarea>
                @error('purpose')
                <small class="text-danger">{{$message}}</small>
                @enderror
              </div>
              <div class="form-group" id="last_date">
                <label for="last_date" class="category font-weight-bold">Son Tarih</label>
                <input placeholder="Tarih için zaman ayarlayın" id="last_dates" type="date" class="form-control "
                       name="last_date" min="<?php echo date('Y-m-d'); ?>" autofocus>
                @error('last_date')
                <small class="text-danger">{{$message}}</small>
                @enderror
              </div>
