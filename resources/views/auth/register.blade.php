          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="card-body mb-2">
              <div class="input-group no-borde mb-2">
                <input placeholder="İsminizi Giriniz" id="name" type="text"
              ...
              <div class="input-group  mb-2">
                <input placeholder="E-Posta Adresinizi Giriniz" id="email" type="email"
             ...
             {{-- <div class="input-group  mb-2">
              ...
              <div class="input-group mb-2">
                <input placeholder="Şifrenizi Tekrar Giriniz" id="password-confirm" type="password" class="form-control"
