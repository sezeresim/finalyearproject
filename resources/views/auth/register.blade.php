                ...
                <div class="card " data-background-color="blue">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="card-header text-center">
                            <h3 class="card-title title-up">Üye Ol</h3>
                        </div>
                        <div class="card-body mb-2">
                            <div class="input-group no-borde mb-2">
                                <input placeholder="İsminizi Giriniz" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            ...
                            <div class="input-group  mb-2">
                                <input placeholder="Doğum Tarihinizi Giriniz"  id="birtdate" type="date" class="form-control " name="birtdate" required autocomplete="birtdate" autofocus>
